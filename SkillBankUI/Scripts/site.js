...
;(function($){ 
    ...
    //Fix header on top on screen(update for class edit page)
    ...
    // Cathy Update slider funtion here
    var saveSliderValue = ($("#classf-hidisproved").length > 0);
    var skillValue = $("#skill-slider-input").val();
    if (skillValue == "" || skillValue == undefined || skillValue < 0 || skillValue > 100) {
        skillValue = 50;
    }
    ...
    if ($("#skill-slider").length > 0) {
        $("#skill-slider").slider({
	      ...
	      create: function (event, ui) {
	          $("#skill-slider").find(".ui-slider-handle").text(skillValue);
	      },
	      ...
	      stop: function (event, ui) {
	          if (saveSliderValue) {
	              classedit.saveClassInfo(5, ui.value);
	          }
	      }
	    });
    ...
    var levelValue = $("#level-slider-input").val();
    if (levelValue == "" || levelValue == undefined || levelValue < 0 || levelValue > 100) {
        levelValue = 50;
    }
    ...
    if ($("#level-slider").length > 0) {
        $("#level-slider").slider({
	      ...
	      value: levelValue,
	      create: function (event, ui) {
	          $("#level-slider").find(".ui-slider-handle").text(levelValue);
	      },
	      change: function( event, ui ) {
	      ...
	      stop: function (event, ui) {
	          if (saveSliderValue) {
	              classedit.saveClassInfo(4, ui.value);
	          }
	      }
	    });
