...
namespace SkillBank.Site.Web.CDN
{
	public class UpYunLibrary
	{
		static void Main(string[] args)
		{
			...
			/// 创建目录
			// Console.WriteLine(upyun.mkDir("/profile/"));
			...
			*/
            ...
            bool b = upyun.writeFile("/a/test.jpg", postArray, true, headers);
	...
	public class UpYun
	{
		...
		* return true or false
		*/
        public bool writeFile(string path, byte[] data, bool auto_mkdir, Hashtable headers)
		{
			this.auto_mkdir = auto_mkdir;
			HttpWebResponse resp;
		...
		*/
        ...
        //计算文件的MD5码
        public static string md5_file(Byte[] oFileStream)
        {
            string strResult = "";
            string strHashData = "";
