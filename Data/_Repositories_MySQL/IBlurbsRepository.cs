...
namespace SkillBank.Site.DataSource.Data
{
    ...
    public class BlurbsRepository : DbContext, IBlurbsRepository//
    {
        ...
        public Dictionary<int, String> Blurbs_LoadByLanguageSiteVersion_p(String language, Byte version)
        {
            ...
            ObjectResult<Blurb> result = ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Blurb>("Blurbs_LoadByLanguageSiteVersion_p", MergeOption.NoTracking, versionParameter, languageParameter);
