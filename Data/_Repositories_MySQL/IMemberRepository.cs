...
namespace SkillBank.Site.DataSource.Data
{
    public interface IMemberRepository
    {
        ...
        Boolean UpdateMemberInfo(int memberId, Byte saveType, String phoneNo, int cityId, String memberName, String intro, bool isMale, String eMail, Decimal posX, Decimal poxY, DateTime birthday, String avatar);
        ...
        void LeaveEmailAddress(String name, String email);
    }
    ...
    public class MemberRepository : DbContext, IMemberRepository//Entities
    {
        ...
        {
            //TO DO:Decide to use social accout or OpenId later

            return MemberInfo_Add_p(out memberId, socialOpenId, socialType, ""/*phone*/, cityId, memberName, avatar, true, email);
        }
        ...
        private MemberInfo MemberInfo_Load_p(Byte loadType, String socialAccount, Byte socialType, int memberId)
        {
            ...
            var result = Context.ExecuteFunction<MemberInfo>("MemberInfo_Load_p", MergeOption.NoTracking, loadByParameter, socialAccountParameter, socialTypeParameter, memberIdParameter).FirstOrDefault();
        ...
        private Boolean MemberInfo_Save_p(int memberId, Byte saveType, String phoneNo, int cityId, String memberName, String intro, Boolean isMale, String eMail, Decimal posX, Decimal posY, DateTime birthday, String avatar)
        {
            ...
            return ((SByte)resultParameter.Value == 0);
        }

        private int MemberInfo_Add_p(out int memberId, String socialId, Byte socialType, String phoneNo, int cityId, String memberName, String intro, Boolean isMale, String eMail)
        {
            memberId = 0;
            //var loadByParameter = new ObjectParameter("SaveType", saveType);
            ...
            ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("MemberInfo_Add_p", socialAccountParameter, socialTypeParameter, memberIdParameter, /*phoneNoParameter,*/ cityIdParameter, memberNameParameter, /*introParameter, genderParameter,*/ eMaileParameter, resultParameter);
            memberId = (int)memberIdParameter.Value;
            return (int)resultParameter.Value;
        }

        public void LeaveEmailAddress(String name, String email)
        {
        }
