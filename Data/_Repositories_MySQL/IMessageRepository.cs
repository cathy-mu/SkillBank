...
namespace SkillBank.Site.DataSource.Data
{
    ...
    {
        int SaveMessage(Byte saveType, int id, int fromId, int toId, String messageText);
    ...
    public class MessageRepository : DbContext, IMessageRepository
    {
        ...
        //{
        //    var typeIdPara = new ObjectParameter("SaveType", Enums.DBAccess.MessageSaveType.Add);

        //    var idPara = new ObjectParameter("Id", message.MessageId);
        //    var fromIdPara = new ObjectParameter("FromId", message.From_Id);
        //    var toIdPara = new ObjectParameter("ToId", message.To_Id);
        //    var messageTextIdPara = new ObjectParameter("Message", message.MessageText);

        //    int result = ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Message_Save_p", fromIdPara, toIdPara, messageTextIdPara, typeIdPara, idPara);
        //    return result;
        //}

        public int SaveMessage(Byte saveType,int id,int fromId,int toId,String messageText)
        {
        ...
        public List<MessageListItem> GetLastestMessagesByMemberId(int memberId)
        {
            ...
            ObjectResult<MessageListItem> result = ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MessageListItem>("Message_LoadByMemberId_p", MergeOption.NoTracking, paraIdPara);
        ...
        public List<Message> GetMessagesByFromToId(int memberId1, int memberId2)
        {
            ...
            var result = Context.ExecuteFunction<Message>("Message_LoadByFromAndToId_p", MergeOption.NoTracking, memberId1Para, memberId2Para);
        ...
        private List<MessageUnReadItem> Message_LoadUnReadNo_p(int memberId)
        {
            ...
            ObjectResult<MessageUnReadItem> result = ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MessageUnReadItem>("Message_LoadUnReadNo_p", MergeOption.NoTracking, memberIdPara);
            return MessageMapper.Map(result);
        }
